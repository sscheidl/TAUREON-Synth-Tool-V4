...
| R-003 | SysEx byte corruption or incomplete capture marked valid | Low | Critical | Stage 3 proves exact `F0...F7` ↔ SysEx7 boundaries, segmentation/reassembly, arbitrary chunks, data-loss taint, `.syx` roundtrip, malformed/truncated cases, 64 KiB/600 KiB/900 KiB/>1 MiB data, and native WMS/WinMM loopbacks | Codex | Closed for generic software layer; hardware/profile follow-up only |
